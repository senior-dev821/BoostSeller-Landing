        ...
        <div className="mx-auto w-full  px-4">
          ...
          >
            ...
            <p className="mb-12 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
              If you already have account, please sign in for Starting or Booking Demo.
            </p>

            <form>
              <div className="cols-1 md:cols-1 gap-6">

                {/* Email */}
                <div>
                  <label
                    htmlFor="email"
                    className="mb-4 block text-sm text-dark dark:text-white"
                  >
                    Email
                  </label>
                  <input
                    ...
                    className="w-full rounded-sm border border-stroke bg-[#f8f8f8] px-4 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:focus:border-primary mb-4"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-sm border border-stroke bg-[#f8f8f8] px-4 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:focus:border-primary mb-6"
                  />
                </div>
                ...
                <div className="col-span-1 md:col-span-2 flex justify-center">
                  <button
                    type="submit"
                    className="rounded-sm bg-primary px-8 py-3 text-base font-medium text-white shadow-submit transition duration-300 hover:bg-primary/90"
                  >
                    Sign In
                  </button>
                </div>
