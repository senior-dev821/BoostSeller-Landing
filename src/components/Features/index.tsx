...
const icons = [
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 64 64" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <g>
          <circle cx="32" cy="12" r="6" stroke="currentColor" strokeWidth="4" fill="none" />
          <path d="M32 18v8M32 26l-10 10M32 26l10 10M32 26l0 10" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
          <circle cx="12" cy="48" r="6" fill="currentColor" />
          <circle cx="32" cy="48" r="6" fill="currentColor" />
          <circle cx="52" cy="48" r="6" fill="currentColor" />
          <path d="M12 54c-4 0-6 4-6 6h12c0-2-2-6-6-6zM32 54c-4 0-6 4-6 6h12c0-2-2-6-6-6zM52 54c-4 0-6 4-6 6h12c0-2-2-6-6-6z" fill="currentColor" />
        </g>
      </svg>
    ),
  },
  ...
  },
  {
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path opacity="0.5" d="M5 35h30v2H5z" />
        <path d="M10 30V20h4v10h-4zM18 30V12h4v18h-4zM26 30V16h4v14h-4z" />
      </svg>
    ),
  },
];
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-2 lg:grid-cols-3">
          {features.length > 0 ? (
            features
              ...
              .map((feature, idx) => (
                <SingleFeature key={feature.id}
								title={feature.title}
								description={feature.description}
								icon={icons[idx % icons.length].icon}  />
              ))
          ) : (
