      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-3 md:w-1/2 lg:w-6/12 xl:w-6/12">
              <div className="mb-8 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-4 text-base leading-relaxed text-body-color">
									BoostSeller helps sales teams respond faster, close smarter, and grow revenue with intelligent lead distribution.
                </p>
                
              </div>
            </div>

            <div className="w-full px-3 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            ...
            <div className="w-full px-3 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
              ...
              <div className="mb-8 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
										<p className="dark:text-body-color-dark mb-4 text-base leading-relaxed text-body-color">
                      Email : info@boostseller.ai
                    </p>
                  </li>
                  <li>
										<p className="dark:text-body-color-dark mb-4 text-base leading-relaxed text-body-color">
                      Phone : +7 123 345 2345
                    </p>
                  </li>
                  <li>
          ...
          <div className="py-5">
            <p className="text-center text-base text-body-color dark:text-white">
							© 2025 BoostSeller. All rights reserved.
            </p>
          </div>
        </div>
