        ...
        <div className="mx-auto w-full  px-4">
          ...
          >
            ...
            <p className="mb-12 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
              Be the first to experience smarter lead distribution.
            </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-sm border border-stroke bg-[#f8f8f8] px-4 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="md:col-span-2 flex items-start">
                  ...
                  <label
                    htmlFor="terms"
                    className="text-sm font-medium text-body-color dark:text-white/70"
                  >
